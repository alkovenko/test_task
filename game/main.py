...
player_generator = CharacterGenerator("text_data/player_data.json", is_enemy=False)
enemy_generator = CharacterGenerator("text_data/enemy_data.json", is_enemy=True)
